...
**QuizForge** is a very simple lightweight web-based application that allows users to upload, take, and manage multiple-choice quizzes. It supports JSON-based quiz uploads and AI model prompts, automatic scoring, and question-by-question navigation with immediate results.
